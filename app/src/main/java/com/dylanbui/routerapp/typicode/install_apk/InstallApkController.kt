...
class InstallApkController: BaseMvpController<InstallApkActionView, InstallApkPresenter>(), InstallApkActionView {
    ...
    override fun createPresenter(): InstallApkPresenter = InstallApkPresenter()

    override fun setTitle(): String? = "Detail Post Id: ${tyPost.id.toString()}"

    override fun inflateView(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.controller_install_apk, container, false)
    }
