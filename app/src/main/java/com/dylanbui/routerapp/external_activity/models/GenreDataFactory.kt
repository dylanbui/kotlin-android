...
import com.dylanbui.routerapp.external_activity.multi_check.MultiCheckGenre
import com.dylanbui.routerapp.external_activity.single_check.SingleCheckGenre
import java.util.*
...
object GenreDataFactory {
    ...
    fun makeMultiCheckGenres(): List<MultiCheckGenre> {
        return Arrays.asList<MultiCheckGenre>(
    ...
    fun makeSingleCheckGenres(): List<SingleCheckGenre> {
        return Arrays.asList<SingleCheckGenre>(
