 ...
 */
inline fun <T> SparseArray<T>.asSequence(): Sequence<T> =
    SparseArraySequence(this)

/**
 * Create a [Sequence] instance that wraps the original [SparseBooleanArray] returning its elements when being iterated.
 */
inline fun <T> SparseBooleanArray.asSequence(): Sequence<Boolean> =
    SparseBooleanArraySequence(this)

/**
 * Create a [Sequence] instance that wraps the original [SparseIntArray] returning its elements when being iterated.
 */
inline fun <T> SparseIntArray.asSequence(): Sequence<Int> =
    SparseIntArraySequence(this)
