...
// https://www.androdocs.com/kotlin/android-circle-imageview-with-border-using-kotlin.html

class DbCircleImageView : ImageView {
    ...
    fun init(context: Context, attrs: AttributeSet?){
        val attributes = context.obtainStyledAttributes(attrs, R.styleable.DbCircleImageView)
        borderColor = attributes.getColor(R.styleable.DbCircleImageView_border_color, Color.WHITE)
        borderWidth = attributes.getDimension(R.styleable.DbCircleImageView_border_width, 0f)
    }
