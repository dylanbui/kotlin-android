...
class DbCircleImageView : ImageView {
    ...
    constructor(
        ...
        val a =
            context.obtainStyledAttributes(attrs, R.styleable.DbCircleImageView, defStyle, 0)
        mBorderWidth = a.getDimensionPixelSize(
            R.styleable.DbCircleImageView_civ_border_width,
            DEFAULT_BORDER_WIDTH
        )
        mBorderColor = a.getColor(
            R.styleable.DbCircleImageView_civ_border_color,
            DEFAULT_BORDER_COLOR
        )
        mBorderOverlay = a.getBoolean(
            R.styleable.DbCircleImageView_civ_border_overlay,
            DEFAULT_BORDER_OVERLAY
        )
        mCircleBackgroundColor = a.getColor(
            R.styleable.DbCircleImageView_civ_circle_background_color,
