 ...
 *
 */
abstract class DbPushManagerMessagingService : FirebaseMessagingService() {

    val pushManager = DbPushManagerImpl
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        val remoteMessageData = DbRemoteMessageData()
     ...
     *
     */
    abstract fun handleNotificationPayload(context:Context, remoteMessageData : DbRemoteMessageData) : DbNotificationData?
     ...
     */
    private fun sendNotification(notificationData: DbNotificationData) {
        ...
        val notificationId = when {
            ...
            notificationData.notificationType == DbNotificationType.STACK -> System.currentTimeMillis().toInt()
            else -> 0
        }
     ...
     *
     */
    private fun generateNotification(notificationData: DbNotificationData, addPublicVersion: Boolean = true): Notification {
        // set required data
