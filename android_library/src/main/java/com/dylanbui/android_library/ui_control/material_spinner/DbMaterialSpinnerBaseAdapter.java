...
public abstract class DbMaterialSpinnerBaseAdapter<T> extends BaseAdapter {
  ...
  public DbMaterialSpinnerBaseAdapter(Context context) {
  ...
  @Override public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (convertView == null) {
      ...
      convertView = inflater.inflate(R.layout.dbms__list_item, parent, false);
...
//      }
  ...
  public DbMaterialSpinnerBaseAdapter<T> setTextColor(@ColorInt int textColor) {
    this.textColor = textColor;
    return this;
  }

  public DbMaterialSpinnerBaseAdapter<T> setBackgroundSelector(@DrawableRes int backgroundSelector) {
    this.backgroundSelector = backgroundSelector;
    return this;
  }

  public DbMaterialSpinnerBaseAdapter<T> setPopupPadding(int left, int top, int right, int bottom) {
