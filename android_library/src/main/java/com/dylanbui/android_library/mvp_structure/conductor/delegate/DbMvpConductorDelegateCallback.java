 ...
 * DbMvpConductorLifecycleListener}. This interface must be implemented by all
 ...
 * @since 1.0
 */
public interface DbMvpConductorDelegateCallback<V extends MvpView, P extends MvpPresenter<V>> {
