...
public class DialogPlusBuilder {
  ...
  private int overlayBackgroundResource = R.color.dialog_plus_black_overlay;
  ...
  public int[] getContentMargin() {
    int minimumMargin = context.getResources().getDimensionPixelSize(R.dimen.dialog_plus_default_center_margin);
