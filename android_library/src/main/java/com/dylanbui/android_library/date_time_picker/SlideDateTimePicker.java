...
public class SlideDateTimePicker
{
    ...
    public enum PickerType {
        // ordinal: 0 , 1 , 2
        // ONLY_TIME error, will be fix later
        ONLY_DATE, BOTH;
    }

    private FragmentManager mFragmentManager;
    private SlideDateTimeListener mListener;
    private PickerType mPickerType = PickerType.BOTH;
    ...
    public static class Builder
    {
        ...
        // Optional
        private PickerType pickerType = PickerType.BOTH; // Default value
        ...
        /**
         * @see SlideDateTimePicker#setPickerType(PickerType)
         */
        public Builder setPickerType(PickerType type)
        {
