...
public class CustomTimePicker extends TimePicker
{
    ...
    public CustomTimePicker(Context context, AttributeSet attrs)
    {
        ...
        try
        {
            ...
            selectionDividerField.set(hourNumberPicker, getResources().getDrawable(R.mipmap.dtpicker_selection_divider));
            selectionDividerField.set(minuteNumberPicker, getResources().getDrawable(R.mipmap.dtpicker_selection_divider));
            selectionDividerField.set(amPmNumberPicker, getResources().getDrawable(R.mipmap.dtpicker_selection_divider));
        }
